...
@section('title', 'Login')
        ...
        <div class="wrapper-page">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0">
                        <a href="#" class="logo logo-admin"><img src="{{Storage::url('/images/logo/'.config('web_config')['WEB_LOGO'])}}" height="40" alt="logo"></a>
                    </h3>
            ...
            <div class="m-t-40 text-center">
                <p>© {{date('Y')}} {{config('web_config')['WEB_TITLE']}}. Crafted with <i class="bi bi-heart text-danger"></i> by <a href="#">Khai</a></p>
            </div>
