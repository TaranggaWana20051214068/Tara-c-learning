...
@endpush
<section class="hero"
    style="background-image: linear-gradient(to right, rgba(135, 50, 134, 0.7), rgba(40, 15, 77, 0.5)),url({{ Storage::url('images/front/' . config('web_config')['HERO_BACKGROUND_IMAGE']) }})">
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="hero-text text-center">
                    <div class="text-title">{{ config('web_config')['HERO_TEXT_HEADER'] }}
                        {{ config('web_config')['WEB_TITLE'] }}</div>
                    ...
                    <div class="col-md-6 mb-5">
                        <a href="{{ route('student.show', ['id' => $student->id]) }}" class='card-student'>
                            <div class="card">
                                <div class="row">
                                    <div class="col-4">
                                        <img src="{{ Storage::url('images/students/' . $student->image_name) }}"
                                            alt="{{ $student->name }}">
                                    </div>
                                    <div class="col-8 py-3 px-3">
                                        <div class="student-name mb-2">{{ $student->name }}</div>
                                        <p class='student-description'>{{ substr($student->description, 0, 125) }}..
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-description">{{ substr($article->content, 0, 110) }}. <a
                                        href="#">Lihat selengkapnya</a></p>
                            </div>
